...
<%
    If memid = "" Or pwd = "" Or memnum = ""  Then
        ...
        response.write "  window.location.href='/.asp';"
                            ...
                            <tbody>  
                                <tr>
                                    ...
                                    <td valign="top">
                                            ...
                                            <table border="0">
                                                <tr>
                                                    <td style="font-size:13px;color:#666; ">
                                                        ...
                                                        ※ 상품예약시 예약이 접수되며, 여행이 확정된 것은 아닙니다. 담당자와 상담 후 예약이 진행 됩니다.<br>
                                        ...
                                        <div style="background: #fdfaef; border:1px solid #ecd0a8; padding:10px 20px;border-radius:0px;">	
                                            <table border="0">
                                                <colgroup>
                                                    <col width="*">
                                                    <col width="45">
                                                ...
                                                <tr height="30">
                                                    <td>
                                                        <div align="left">
                                                            <span style="font-size:13px;font-weight:500; padding:0 15px 0 0;"><i class="xi-user xi-x"></i> <%=GLOBAL_SIN%></span>
                                                            <span style="font-size:13px;font-weight:900; padding:0 15px 0 0;"><i class="xi-call xi-x"></i> <%=GLOBAL_COM_TEL%></span>
                                                            <span style="font-size:13px;"><i class="xi-mail xi-x"></i> <%=GLOBAL_MAIL%></span>
                                                        </div>
                                                    </td>
                                                    <td><a onClick="javascript:listMail('sendmail_mem.asp?num=<%=num%>&g_kind=<%=g_kind%>&s_area=<%=s_area%>');" style="cursor:pointer;" title="메일"><div class="day_sns"><div style="padding:7px 0 0 0;"><i class="xi-mail"></i></div></div></a></td>
                                                    <td><a onClick="javascript:listView('print_ticket.asp?num=<%=num%>&g_kind=<%=g_kind%>&s_area=<%=s_area%>');" style="cursor:pointer;" title="인쇄"><div class="day_sns"><div style="padding:7px 0 0 0;"><i class="xi-print"></i></div></div></a></td>
                                                </tr>
                                            </table>
                                        </div>
                                    </td>
                            ...
                            <tr>
                                ...
                                <td valign="top">
                                    ...
                                    <div class="sidebar1">
                                        ...
                                        <div style="border-bottom:1px solid #EAEAEA;border-left:1px solid #000; border-right:1px solid #000; padding:30px 20px;">  
