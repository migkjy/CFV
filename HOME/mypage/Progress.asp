...
<body bgcolor=#d4d0c8 topmargin=0>
    <%
        If bWorking = true Then
            '업로드 진행 상태를 출력합니다.
            Response.Write "<table border=0 width=360 cellpadding=0 cellspacing=0 style='background:#D4D0C8;'>"
            Response.Write "    <tr>"
            Response.Write "    	<td colspan=2 height=25 valign=bottom style='color:#FFF;'><b>파일 업로드 중... </b></td>"
            Response.Write "    </tr>"
            Response.Write "    <tr>"
            ...
            Response.Write "    <tr>"
            Response.Write "    	<td align=left style='color:#FFF;'>전송 파일 : " & strFileName & "</td>"
            Response.Write "    </tr>"
            Response.Write "    <tr>"
            Response.Write "    	<td align=lef style='color:#FFF;'t>전송 속도 : " & round(BytesPer/(1024*1024),2) & " MB / sec </td>"
            Response.Write "    </tr>"
            Response.Write "    <tr>" 
            Response.Write "    	<td align=left style='color:#FFF;'>진행률 : " & round(TransferBytes/(1024*1024),2) & " MB / " & round(TotalBytes /(1024*1024),2) & " MB (" & Percent & "%)</td>"
            Response.Write "    </tr>"
            Response.Write "</table>"
            Response.Write "<br><br>"
            Response.Write "<table border=0 width=360 cellpadding=0 cellspacing=0 bgcolor=#D4D0C8 style='background:#D4D0C8;'>"
            Response.Write "    <tr>"
            Response.Write "        <td style='color:#FFF;'>데이타 전송중입니다... 잠시만 기달려주세요.</td>"
            Response.Write "    </tr>"
            Response.Write "</table>"
        Else
