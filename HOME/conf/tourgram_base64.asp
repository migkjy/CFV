...
Function Base64_Encode(ORIGNvalue)
	   Base64_Encode = strAnsi2Unicode(Base64encode(strUnicode2Ansi(ORIGNvalue)))
End Function

Function Base64_Decode(EncodeA)
	   Base64_Decode = strAnsi2Unicode(Base64decode(strUnicode2Ansi(EncodeA)))
End Function
