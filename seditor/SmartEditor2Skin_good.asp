...
<script src='photo_uploader/plugin/hp_SE2M_AttachQuickPhoto_good.js' charset='utf-8'></script>
</head>
<body>
		...
		<div class="se2_tool" id="se2_tool">
			...
			<ul class="se2_font_type">
				<li class="husky_seditor_ui_fontName"><button type="button" class="se2_font_family" title="글꼴"><span class="husky_se2m_current_fontName">글꼴</span></button>
					...
					<div class="se2_layer husky_se_fontName_layer">
						<div class="se2_in_layer">
							...
							<li class="husky_seditor_font_malgungothic"><button type="button"><span>맑음고딕<span>(</span><em style="font-family:'맑음고딕',NanumGothic,Sans-serif;">가나다라</em><span>)</span></span></button></li>
				...
				<ul class="se2_multy">
				    ...
				    <tr>
				    <td width="10"></td> 
				    <td><a href="javascript:photo_up('<%=i%>');"><span class="se2_icon"></span></a></td>
				    <td><a href="javascript:photo_up('<%=i%>');"><span class="se2_mntxt" >사진</span></a></td>
				    <td width="10"></td> 
				    </tr>
				    </table>
				</ul>
...
function photo_up(n)
{
   ...
   var winEditor_2n;
   var _url="/seditor/photo_uploader/popup/photo_goodup.asp?tp="+n;
   params = "  top=30,left=0, width=400 , height=300 ,menubar=no, status=no, scrollbars=yes, toolbar=no, location=no,resizable=no, fullscreen=no ";

   winEditor_2n = window.open(_url , "winEditor_2n",params);
   winEditor_2n.focus();
