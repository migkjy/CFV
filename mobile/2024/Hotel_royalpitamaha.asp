...
<body>
    ...
    <div id="wrap" data-role="page" data-dom-cache="false">
        ...
        <!--#include virtual="/mobile/include/top_menu.asp"-->
         ...
         <div style="width:100%;height:200px;background:url('/board/upload/main_img/bk_Pita.jpg') no-repeat;background-position:top center;background-size:cover;">
            <div align="center">
                <table width="100%" height="200" border="0" cellpadding="0" cellspacing="0" style="background:url('/images/main/bg_main.png')">
                    <tr>
                        <td>
                            <div align="center">
                                <div class="sub_top_en">Royal Pita Maha Hotel</div>
                                <div class="sub_top_ko">로얄 피타 마하 호텔</div>
                            </div>
                        </td>
                    </tr>
                </table>
