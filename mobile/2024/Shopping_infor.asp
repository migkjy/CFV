...
<body>
    ...
    <div id="wrap" data-role="page" data-dom-cache="false">
        ...
        <%
            ...
            CloseF5_DB objConn
        %> 
        <div style="width:100%;height:200px;background:url('/board/upload/main_img/<%=e_img(7)%>') no-repeat;background-position:top center;background-size:cover;">
            <div align="center">
                <table width="100%" height="200" border="0" cellpadding="0" cellspacing="0" style="background:url('/images/main/bg_main.png')">
                    <tr>
                        <td>
                            <div align="center">
                                <div class="sub_top_en"><%=e_title(7)%></div>
                                <div class="sub_top_ko"><%=e_remark(7)%></div>
                            </div>
                        </td>
                    </tr>
                </table>
