...
<%  If me_Cnt <> 0 then %>
    ...
    <div id="divpop" style="width:100%;height:auto;background:url('/images/main/pop_bg.png');position:absolute;z-index:1000;visibility:hidden;">
        <div style="padding:150px 20px 500px 20px;">
            <div align="center">
                <table width="100%" border="0 cellpadding="0" cellspacing="0">
                    <tr>
                        <td style="width:100%;height:auto;background:url('/images/main/matching_bg.png')no-repeat;background-position:top center;background-size:cover;height:434px;border-radius:20px;" valign="top">
                            <div align="center">
                                <div style="font-size:1.13em; font-weight:700; padding:80px 0 5px 0;"><%=mem_nm%>님</div>
                                <div>
                                    <span style="font-size:1.00em; font-weight:500;">룸메이트 매칭이</span>
                                    <span style=color:#FF5000;font-size:1.13em;"><strong>"<%=me_Cnt%>"</strong></span>
                                    <span style="font-size:1.00em; font-weight:500;">건</span>
                                </div>
                                <div style="font-size:1.00em; font-weight:500;">요청이 있습니다.</div>
                                
                                <a href="/mobile/mypage/my_page.asp">
                                    <div style="font-size:0.81em; padding:5px 0 5px 0;">마이페이지에서<br>매칭 확정을 선택하세요</div>
                    ...
                    <tr height="45">
                        <td align="center">	
                            <form name="notice_form" style="display:inline; margin:0px;">
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td width="70%"style="padding:0px 0px 0px 1px"><span class="checks"><input type="checkbox" name="chkbox" id="chkbox" value="checkbox"><label for="chkbox"><span style="color:#FFFFFF; font-size:1.00em;">다시보지 않기</span></label></span></td>
