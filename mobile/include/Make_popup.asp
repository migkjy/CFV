...
<% if dia_pop="Y" then %>
    ...
    <div id="divpop" style="width:100%;height:auto;background:url('/images/main/pop_bg.png');position:absolute;z-index:1000;visibility:hidden;">
        <div style="padding:120px 0px 2250px 0px;">
            <div align="center">
                <table style="width:80%; height:auto;" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td align="center">	
                            <form name="notice_form" style="display:inline; margin:0px;">
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td width="70%"style="padding:0px 0px 0px 1px"><span class="checks"><input type="checkbox" name="chkbox" id="chkbox" value="checkbox"><label for="chkbox"><span style="color:#FFFFFF; font-size:0.938em;font-weight:700;">다시보지 않기</span></label></span></td>
