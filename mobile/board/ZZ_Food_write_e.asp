                ...
                <div class="board_write"> 
                    <table>
                        ...
                        <tbody>  
                            ...
                            <tr height="54">
                                <td class="typ3"><font color="#E9250B">*</font> 이미지</td>
                                <td class="typ4"><input type="file" name="srcfile" style="width:100%;" class="input_file" /></td>
                            </tr>
                        </tbody>
                    </table>

                    <div><textarea name="ir_1" id="ir_1" style="width:100%;height:400px; display:none;"></textarea></div>
                        ...
                        <tbody>  
                            <tr>
                                ...
                                <td class="typ4">
                                    ...
                                    <span class="disc">&nbsp;비밀번호는 숫자와 영문자를 혼용하여야 합니다. (최대 10자이내)</span>
                                </td>
                            </tr>
                            <tr>
