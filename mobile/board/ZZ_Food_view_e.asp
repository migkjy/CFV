            ...
            <div class="infor_list">
                ...
                <div class="board_btn_w">
                    <ul class="btn_r">
                        ...
                        <li class="color"><a onclick="fn_pass('common_pa_e.asp?num=<%=num%>&f_ts=food_upd_e');return false;" style="cursor:pointer;">수정</a></li>	
                    </ul>
                </div>
                ...
                <div class="dat_box">
                    ...
                    %> 
                        <div align="left">
                            <table>
                            	<tr>
                            		<td width="40px;" valign="top" style="font-size:0.875em; padding:5px 10px 0 0;font-weight:500;"><%=r_user_nm%></td>
                            		<td>
                            		    <table width="100%">
                            		        <tr>
                            		            <td class="dat_q_1"></td>
                            		            ...
                            		            <td class="dat_q_9">
                            		                ...
                            		                <table width="100%">
                            		                	<tr>
                            		                        ...
                            		                        <td>
                            		                            <div class="dat_ico">
                            		                                <img src="/images/community/dat_delete.png" border="0" height="20" style="cursor:pointer;" onclick="dat_layer('<%=r_seq%>','on');">
