...
<body>
    ...
    <div style="padding:10px 10px 50px 0px">
        ...
        <div class="title_sujet"><i class="xi-align-left xi-x"></i> 모바일 카테고리</div>

        <%
            img_size_remark =" 가로 700x 세로 645px"
        
            OpenF5_DB objConn
        
            sql ="SELECT  top 8 num, i_img, i_url, title, remark, use_yn from  main_new_img  where g_kind='20' and sub_kind='M' order by num asc  "
        ...
        <form  name="uploadForm<%=r_num%>"  method="post" enctype="multipart/form-data"  >
            <div class="table_box">
                <table>
                    <tr>
                        <td width="390px" class="lop1" valign="top"><div align="left"><img src="/board/upload/main_img/<%=r_img%>" width="100%" border="0"></div></td>
