...
<body>
    ...
    <div style="padding:10px 10px 50px 0px">
        ...
        <div class="title_sujet"><i class="xi-align-left xi-x"></i> 카테고리-1</div>

        <%
            OpenF5_DB objConn
        
            sql ="SELECT  top 8 num, i_img, i_url, title, remark, use_yn from  main_new_img  where g_kind='20' and sub_kind='P' order by num asc  "
