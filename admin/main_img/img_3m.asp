...
<body>
    ...
    <div style="padding:10px 10px 50px 0px">
        ...
        <div class="title_sujet"><i class="xi-align-left xi-x"></i>카테고리-3</div>
    
        <%
            OpenF5_DB objConn
      
            sql ="SELECT  top 4 num, i_img, i_url, title ,remark from  main_new_img  where g_kind='40' and sub_kind='M' order by num asc  "
