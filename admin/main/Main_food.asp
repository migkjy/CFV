        ...
        <% 
            Else 
               ...
               Do Until Rs.EOF
                  ...
                  n_ins_dt = Rs("ins_dt")
        %>
        <tr height="26" bgcolor="#FFFFFF" onmouseover="this.style.backgroundColor='#D7ECFF';" onmouseout="this.style.backgroundColor='';" style="cursor:pointer;" onclick="location.href='/admin/board/after_view.asp?num=<%=n_num%>'">
